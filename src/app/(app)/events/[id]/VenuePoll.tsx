      ...
      {isCaptain && options.length < 3 && (
        <form onSubmit={handleAddOption} className="flex gap-2">
          <input
            ...
            maxLength={120}
            className="flex-1 rounded-lg border border-gray-300 px-3 py-1.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
          />
          <button
            type="submit"
